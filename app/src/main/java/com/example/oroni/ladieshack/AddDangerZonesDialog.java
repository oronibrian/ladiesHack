...
import com.example.oroni.ladieshack.data.ProductContract;

/**
 * Created by oroni on 11/27/16.
 */

public class AddDangerZonesDialog extends DialogFragment     {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View addView = inflater.inflate(R.layout.dialog_add_danger_zones, null);
        ...
        final Dialog d = builder.setView(addView)
                .setPositiveButton(R.string.add_location, null)
                .setNegativeButton(R.string.cancel, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        AddDangerZonesDialog.this.getDialog().cancel();
                    }
                })
                .create();
            ...
            public void onShow(DialogInterface dialog) {
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        EditText editTextQuantity = (EditText) addView.findViewById(R.id.latitude);
                        EditText editTextPrice = (EditText) addView.findViewById(R.id.longitude);
